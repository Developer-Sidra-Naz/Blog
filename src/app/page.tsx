...
export const products = [
  ...
  { 
    ...
    des4:"Next.js is a versatile React framework that simplifies modern web development by combining frontend and backend capabilities. Its flexibility, SEO optimization, and excellent developer experience make it an ideal choice for building high-performance web applications. Whether you're creating a blog, e-commerce site, or enterprise application, Next.js provides the tools to deliver an exceptional user experience.",
  ...
  { 
    ...
    des2:"Tailwind offers utility classes (e.g., p-4 for padding or text-center for centering text) to quickly style elements without writing CSS from scratch.Speeds up development by enabling developers to design directly in the markup.Tailwind's configuration file (tailwind.config.js) allows full customization of colors, spacing, and breakpoints. Built-in responsive utilities (e.g., md:text-lg, lg:p-6) make it easy to create designs that adapt to different screen sizes.Tailwind automatically removes unused CSS in production using tools like PurgeCSS, ensuring optimized performance.",
    ...
    des4:"Tailwind CSS revolutionizes frontend development by eliminating the need for writing traditional CSS while providing unmatched flexibility and efficiency. It empowers developers to build custom, responsive designs directly in their markup, making it a preferred choice for modern web projects. Whether you're working on a simple website or a complex application, Tailwind CSS offers the tools you need to design with ease and precision.",
  ...
  { 
    ...
    des2:"Ideal for developers who need full control over their UI components to match their design systems or brand guidelines.You are not tied to a predefined style or theme, making it easy to evolve your application's look over time.Ensures a better user experience for everyone, including those relying on assistive technologies.TypeScript support, modern API design, and flexibility make it a developer-friendly choice.",
    des3:"1. Install the Library:To start using Shadcn/ui, install it in your React project. Typically, this is done through a package manager like npm or yarn.2. Import Components: Shadcn/ui offers a variety of accessible, composable components. These components are unstyled by default, allowing you to apply your styling methods. Customize with Your Styling System:Since Shadcn/ui doesn't enforce any styling, you can style components using Tailwind CSS and custom CSS",
    des4:"Shadcn/ui is a game-changer for developers looking for a lightweight, accessible, and highly customizable component library. By prioritizing flexibility and accessibility, it empowers developers to create unique and inclusive user experiences without the constraints of predefined styles or locked-in themes. Whether you're building a small application or a complex enterprise-grade system, Shadcn/ui provides the building blocks to bring your design vision to life.",
